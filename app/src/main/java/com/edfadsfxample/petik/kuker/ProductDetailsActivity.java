    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        addToCartBtn.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
               ...
               {
                   Toast.makeText(ProductDetailsActivity.this, "you can add purchase more products, once your order is shipped or confrimed.", Toast.LENGTH_LONG).show();
               }
               else
               {
                   addingToCartList();
        ...
        cartListRef.child("User View").child(Prevalent.currentOnlineUser.getId())
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>()
                {
                    ...
                    public void onComplete(@NonNull Task<Void> task)
                    {
                        ...
                        {
                            cartListRef.child("Admin View").child(Prevalent.currentOnlineUser.getId())
                                    .child("Products").child(productID)
                                    .updateChildren(cartMap)
                                    .addOnCompleteListener(new OnCompleteListener<Void>()
                                    {
        ...
        productsRef.child(productID).addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                if (dataSnapshot.exists())
                {
                    ...
                    productName.setText(products.getProdukname());
