...
import com.edfadsfxample.petik.kuker.Model.AdminOrders;
...
public class AdminNewProductActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        ordersList = findViewById(R.id.admin_cart_list);
                    ...
                    protected void onBindViewHolder(@NonNull AdminOrdersViewHolder holder, final int position, @NonNull final AdminOrders model)
                    {
                        ...
                        holder.ShowOrderBtn.setOnClickListener(new View.OnClickListener()
                        {
                            ...
                            public void onClick(View v)
                            {
                                ...
                                Intent intent = new Intent(AdminNewProductActivity.this, AdminUserProductsActivity.class);
    ...
    {
        public TextView userName, userPhone, userTotalPrice, userDateTime, userShippingAddress, userEmail;
